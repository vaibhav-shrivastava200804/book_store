...
function First() {
  ...
  return (
    <div className='border-[#AE8E1C] border-[2px] h-[24rem] m-1 mt-4 rounded-sm flex flex-col gap-2  bg-gradient-to-tr from-[#650D1B] via-[#DE0D30] to-[#632228]'>
        <div className='Headline h-10 flex items-center p-3 bg-gradient-to-tr from-[#650D1B] via-[#DE0D30] to-[#632228] shadow-xl'>
        ...
        <div className="cards custom-scroll flex-1 flex flex-col sm:flex-row items-center overflow-x-auto gap-5 mb-1 p-1 shadow-2xl">
            {books.map((book) => (
          <div key={book.key} className="flex flex-col gap-1 border-[white] border-[1px] rounded-md w-[240px] sm:w-[170px] flex-shrink-0 h-[400px] sm:h-[300px] overflow-clip hover:overflow-auto custom-scroll p-1">
            <img
              src={
                book.cover_id
              ...
              alt={book.title}
              className="mb-2 w-[200px] h-[300px] sm:w-[150px] sm:h-[200px] border border-[#3e0042] mt-1 mx-auto rounded-md cursor-pointer hover:scale-105 duration-200"
            />
            <div className="detail flex flex-col gap-2 sm:gap-0 mb-2 sm:mb-0 overflow-hidden hover:overflow-y-scroll custom-scroll">
