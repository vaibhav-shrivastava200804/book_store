...
function intro() {
  return (
    <div className='mt-2 h-fit flex flex-col md:flex-row items-center justify-center rounded-md bg-gradient-to-tr from-[#650D1B] via-[#DE0D30] to-[#632228] gap-10 p-2 shadow-2xl m-1'>
        <img src="src\assets\introImage.png" alt="image" className='w-96 h-[50%] sm:w-[90%] md:w-100 sm:h-full rounded-md shadow-xl hover:scale-105 cursor-pointer duration-300' />
