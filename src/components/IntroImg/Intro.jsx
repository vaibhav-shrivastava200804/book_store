...
function intro() {
  return (
    <div className='mt-2 h-fit flex flex-col md:flex-row items-center justify-center rounded-md bg-[#003153] bg-[linear-gradient(315deg,_#003153_0%,_#1B1B1B_74%)] gap-10 p-2 shadow-2xl m-1'>
