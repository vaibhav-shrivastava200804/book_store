          ...
          <div className="cards custom-scroll flex flex-col sm:flex-row overflow-y-scroll sm:flex-wrap items-center sm:justify-around sm:gap-10 gap-5 mb-1 p-1 shadow-2xl border rounded-lg h-auto w-[95%] mx-auto">
            {loading ? (
              ...
              books.map((book) => (
                <div
                  key={book.key}
                  className="flex flex-col gap-1 border-[white] justify-between border-[1px] rounded-md w-[300px] sm:w-[320px] p-1 flex-shrink-0 h-[580px] sm:h-[500px] overflow-clip hover:overflow-auto custom-scroll"
                >
                  ...
                  <div className="detail flex flex-col h-[100px] sm:gap-0 mx-1 my-2 overflow-y-auto custom-scroll">
                    <h3 className="text-white ml-1 text-lg">
                      <b className="font-extrabold uppercase text-[white]">
                        Title:
                      </b>{" "}
